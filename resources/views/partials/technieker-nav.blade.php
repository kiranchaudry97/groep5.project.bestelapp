<nav class="bg-white shadow-sm border-b mb-6">
  <div class="max-w-7xl mx-auto px-4 py-3 flex justify-between items-center">
    ...
    <div class="flex items-center gap-3">
      ...
      <span class="text-lg font-semibold text-gray-700">Technieker Portaal</span>
    </div>
    ...
    <div class="flex items-center space-x-3 text-sm">
      ...
      <!-- ✅ Nieuw: Profiel -->
      <a href="{{ route('profile.edit') }}" class="bg-blue-400 text-white px-4 py-1 rounded-full font-semibold hover:bg-blue-500">Profiel</a>
